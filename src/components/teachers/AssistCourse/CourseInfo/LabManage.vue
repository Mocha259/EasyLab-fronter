        ...
        <el-col :span="5" v-for="o in exp" :key="o.experiment_id" :offset="2">
          <el-card style="height: 280px; width: 230px">
            ...
            <div style="">
              ...
              <div v-else  style="margin-bottom: 10px; margin-left: 10px" >
                实验状态：<el-tag type="danger">关闭</el-tag>
              </div>
              <div class="bottom clearfix" style="position: absolute; bottom: 10px; margin-left: 40px">
                <el-button type="primary" round @click="intoCertainLab(o.experiment_id)">进入批改</el-button>
