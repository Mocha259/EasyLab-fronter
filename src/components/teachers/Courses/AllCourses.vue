<template>
    ...
    <div class="CoursesInfoContainer">
        ...
        <el-button style="position: relative; top: 20px; left: 20px" @click="dialogVisible = true">开设课程</el-button>
        ...
        :before-close="handleClose">
            课程名称：<el-input v-model="courseName" style="margin-bottom: 10px"></el-input>
            课程简介：<el-input v-model="courseIntro" style="margin-bottom: 10px"></el-input>
            ...
            style="height: 150px">
                ...
                <el-button type="primary" style="margin-bottom: 20px">选取课程封面</el-button>
            </el-upload>
